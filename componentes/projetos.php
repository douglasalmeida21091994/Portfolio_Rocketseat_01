...
$itensProjetos = [
    ...
    [
        ...
        "descricao2" => "Para acessar a página em produção, disponível no site da Smile Saúde, <a class='text-blue-600 hover:underline' href='https://smilesaude.com.br/rol_ans/index.html'>clique aqui</a>",
